clean, decoded, fr, to = [input() for _ in range(4)]
d_f, d_b = dict(zip(list(clean), list(decoded))), dict(zip(list(decoded), list(clean)))
print("".join([d_f[x] for x in list(fr)]))
print("".join([d_b[x] for x in list(to)]))
